...
public class RemoteOnlineProcessor implements IMessageProcessor {

	private static Log log = LogFactory.getLog(RemoteOnlineProcessor.class);
	...
	public void process(JSONObject message)
	{
		...
		hiGatewayService.updateSingnalFlag(gatewayVo.getPtGatewayid(), 0);
	}
