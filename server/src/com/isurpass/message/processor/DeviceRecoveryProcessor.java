...
public class DeviceRecoveryProcessor implements IMessageProcessor
{
	private static Log log = LogFactory.getLog(DeviceRecoveryProcessor.class);
	...
	public void process(JSONObject message)
	{
		...
		hiDeviceService.updateSingnalFlag(deviceVo.getPtDeviceId(), 0);
