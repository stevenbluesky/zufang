...
! function() {
	...
	Page.prototype.view = function() {
		...
		conf.first = 'first' in conf ? conf.first : label.shouye;
		conf.last = 'last' in conf ? conf.last : label.weiye;
		conf.prev = 'prev' in conf ? conf.prev : label.shangyiye;
		conf.next = 'next' in conf ? conf.next : label.xiayiye;
