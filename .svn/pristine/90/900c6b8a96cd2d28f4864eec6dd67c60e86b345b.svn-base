define('components/kindeditor/kindeditor', ['require', 'exports', 'module'], function(require, exports, module) {

  /**
   * @require "components/kindeditor/themes/default/default.css"
   */
