define('static/libs/laydate/laydate', ['require', 'exports', 'module'], function(require, exports, module) {
  ...
  /**
   ...
   @require static/libs/laydate/need/laydate.css
   @require static/libs/laydate/skins/molv/laydate.css
   */
  ;
  ! function(a) {
  	var b = {
