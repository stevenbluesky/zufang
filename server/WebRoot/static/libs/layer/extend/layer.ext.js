define('static/libs/layer/extend/layer.ext', ['require', 'exports', 'module', 'static/libs/layer/layer'], function(require, exports, module) {

  /*! layer弹层组件拓展类 */ ;
  /**
   * @require "static/libs/layer/skin/layer.ext.css"
   */
  ! function() {
  	var layer = require('static/libs/layer/layer');
  	var a = layer.cache || {},
  		b = function(b) {
