define('static/libs/util/common', ['require', 'exports', 'module', 'components/jquery/jquery', 'static/libs/util/config', 'static/libs/util/cookie', 'static/libs/layer/layer', 'components/nprogress/nprogress', 'components/jquery-placeholder/jquery.placeholder'], function(require, exports, module) {
