...
public class TamplerAlarmProcessor implements IMessageProcessor
{
	private static Log log = LogFactory.getLog(TamplerAlarmProcessor.class);
	...
	public void process(JSONObject message)
	{
		...
		hiDeviceService.tampleralarm(deviceVo.getPtDeviceId());
	}
