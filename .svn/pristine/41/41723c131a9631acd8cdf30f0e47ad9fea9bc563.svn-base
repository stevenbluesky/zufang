define('components/webuploader/base', ['require', 'exports', 'module', 'components/webuploader/dollar', 'components/webuploader/promise'], function(require, exports, module) {
  ...
  var promise = require('components/webuploader/promise');
  var noop = function () {
      }, call = Function.call;
