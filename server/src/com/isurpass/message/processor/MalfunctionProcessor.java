...
public class MalfunctionProcessor implements IMessageProcessor
{
	private static Log log = LogFactory.getLog(MalfunctionProcessor.class);
	...
	public void process(JSONObject message)
	{
		...
		hiDeviceService.updateSingnalFlag(deviceVo.getPtDeviceId(), 1);
