define('components/webuploader/widgets/queue', ['require', 'exports', 'module', 'components/webuploader/base', 'components/webuploader/uploader', 'components/webuploader/queue', 'components/webuploader/file', 'components/webuploader/lib/file', 'components/webuploader/runtime/client', 'components/webuploader/widgets/widget'], function(require, exports, module) {
  ...
  var Queue = require('components/webuploader/queue');
  var WUFile = require('components/webuploader/file');
  var File = require('components/webuploader/lib/file');
